...
import menu from "./mocks/menu.js";
...
const createStructureHeader = () => {
  ...
  const wrapperInputSearch = createElement("div","wrapper-input-search",wrapperSearch);
  const btnCategory = createElement("button","btn-category",wrapperInputSearch);
  btnCategory.textContent = "Categorias";
  const searchProduct = createElement("input","search-product",wrapperInputSearch);
