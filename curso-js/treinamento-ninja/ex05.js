...
desafio.
*/
let teams = ["São Paulo", "Palmeiras", "Corinthians", "Santos", "Santo André"];
...
*/
let showTeamPosition = function (param) {
  if (param < 0 || param > 4) {
    return `Não temos a informação do time que está nessa posição.`;
  }
  return `O time que está em ${param + 1}º lugar é o ${teams[param]}. `;
};
...
count = 0;
while (count < 4) {
  console.log(showTeamPosition(count));
  count++;
}
teams[2] = "São Bernardo";
console.log(teams);
console.log(showTeamPosition(2));
/*
