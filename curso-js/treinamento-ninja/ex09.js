...
function calculator(n1,n2){
  return function ortherFunction(callback){
...
*/
  console.log(`O resultado da soma é: ${sum(function newFunction(n1,n2){return n1+n2})}`);
  // ?
...
chamada.
*/
  console.log(`O resultado da subtração é: ${subtraction(function subtrair(n1,n2){return n1- n2})}`);
  // ?

  console.log(`O resultado da multiplicação é: ${multiplication(function multiplica(n1,n2){return n1*n2})}`);
  // ?

  console.log(`O resultado da divisão é: ${division(function dividir(n1,n2){return n1/n2})}`);
  // ?

  console.log(`O resto da divisão é: ${mod(function resto(n1,n2){return n1%n2})}`);
  // ?
})();
