...
pessoa.apresentacao = function(){
  ...
  pessoa.sexo === 'm'? sexo = "o" : sexo = "a"
  pessoa.caminhouQuantosMetros === 1? metro = "metro" : metro = "metros"
  pessoa.idade === 1? idade = "ano" : idade = "anos"

  if(pessoa.sexo === 'm'){
    return `Olá, eu sou ${sexo} ${pessoa.nomeCompleto}, tenho ${pessoa.idade} ${idade}, ${pessoa.altura} de altura, meu peso é ${pessoa.peso}kg e, só hoje, eu já caminhei ${pessoa.caminhouQuantosMetros} ${metro}`
  } else{
    return `Olá, eu sou ${sexo} ${pessoa.nomeCompleto}, tenho ${pessoa.idade} ${idade}, ${pessoa.altura} de altura, meu peso é ${pessoa.peso}kg e, só hoje, eu já caminhei ${pessoa.caminhouQuantosMetros} ${metro}`
  }
